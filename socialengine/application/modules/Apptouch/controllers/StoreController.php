...
//    !$this->_helper->requireAuth()->setAuthParams($page, null, 'edit')->isValid() ||
  ...
  public function productsEditAction()
  {
    ...
    $manage_menus = $this->getNavigation(array('manage'), array('product_id' => $product->getIdentity()));
...
//    $this->view->filterValues = $values;
  ...
  public function photoEditAction()
  {
    ...
    $this->add($this->component()->subjectPhoto($product))
      ->add($this->component()->itemList($paginator, 'photoManageList'))
      ->add($this->component()->paginator($paginator))
...
//    !$this->_helper->requireAuth()->setAuthParams($page, null, 'edit')->isValid() ||
  ...
  public function cartIndexAction()
  {
    ...
    $total = $totalItemAmt + $totalShippingAmt + $totalTaxAmt;
//    $this->view->cart          = $cart;
...
//    $this->view->taxesPrice    = $totalTaxAmt;
    ...
    $this
      ...
      ->add($this->component()->itemList($paginator, 'cartProductList'))
      ->add($this->component()->paginator($paginator))
      ->renderContent();
  }
...
//    $this->redirect($this->view->url(array('controller' => 'cart'), 'store_extended', true));
  ...
  public function browseProductList(Core_Model_Item_Abstract $item)
  {
    ...
    $customize_fields = array(
      ...
      'creation_date' => '',
      'href' => $item->getHref(),
      'descriptions' => array($item->getDescription(), $description, $price_block),
            'manage' => $options
    );
    ...
    if (in_array('prod_loc_add', $type)) {
      $navigation->addPages(array(
          array(
            ...
            'route'  => 'store_product_locations',
            'action' => 'add',
            'params' => array('product_id' => $params['product_id'], 'parent_id' => $params['parent_id']),
            //'data_attrs' => ''
          ))
      );
    }
