...
//  Member Controller {
  ...
  public function memberJoinAction()
  {
    ...
    if ($subject->membership()->isMember($viewer)) {
      ...
      return $this->redirect('refresh', Zend_Registry::get('Zend_Translate')->_('You are already a member of this group.'));
    }
  ...
  public function memberLeaveAction()
  {
    ...
    if ($this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost())) {
      ...
      return $this->redirect('refresh', Zend_Registry::get('Zend_Translate')->_('You have successfully left this group.'));
    } else
      $this->add($this->component()->form($form))
        ->renderContent();
  }
...
//  Tabs {
  ...
  public function topicIndexAction()
  {
    ...
    $this->add($this->component()->itemList($paginator))
      ->add($this->component()->paginator($paginator))
      ->renderContent();
  }
