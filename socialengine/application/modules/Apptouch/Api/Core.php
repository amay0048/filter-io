...
//    return true;
  ...
  public function getFacebookLoginButton($connect_text = 'Connect with Facebook')
  {
    ...
    $fbBtn = <<<HTML
    		<div onclick="{$onclick}" class="fb-connect-btn" data-role="controlgroup" data-type="horizontal" data-theme="b">
    			<a data-role="button" data-icon="facebook" data-theme="b" data-iconpos="notext"></a>
    			<a href="{$href}" data-role="button" data-ajax=false data-theme="b">{$fbConnectText}</a>
    		</div>
HTML;
  ...
  public function getTwitterLoginButton($connect_text = 'Sign in with Twitter')
  {
    ...
    $twBtn = <<<HTML
    		<div onclick="{$onclick}" class="tw-connect-btn" data-role="controlgroup" data-type="horizontal" data-theme="b">
    			<a data-role="button" data-icon="twitter" data-theme="b" data-iconpos="notext"></a>
    			<a href="{$href}" data-role="button" data-ajax=false data-theme="b">{$fbConnectText}</a>
    		</div>
HTML;
