...
Webflow.require('ix').init([
  {"slug":"open-detail","name":"open detail","value":{"style":{},"triggers":[{"type":"click","selector":".entry-modal","stepsA":[{"display":"none","opacity":0,"transition":"opacity 500ms ease 0ms"},{"display":"block","opacity":1,"transition":"opacity 250ms ease 0ms"}],"stepsB":[]}]}},
  {"slug":"close-detail","name":"close detail","value":{"style":{},"triggers":[{"type":"click","stepsA":[{"opacity":0,"transition":"opacity 250ms ease 0ms"},{"display":"none"}],"stepsB":[]}]}}
]);
