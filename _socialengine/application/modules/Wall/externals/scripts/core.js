...
// settings
    ...
    window.array_reverse = function(array, preserve_keys) {
...
// Extend Paste Event
    ...
    window.Wall_htmlspecialchars = function(text) {
        var chars = Array("&", "<", ">", '"', "'");
    ...
    window.WallPreload = function(images){
