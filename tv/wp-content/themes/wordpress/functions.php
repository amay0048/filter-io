...
<div class="w-container banner-container wp-widget" id="header-banner-rotator">
      <div class="banner-item" data-ix="banner-rotation">
        <?php echo "<img class=\"banner-image\" src=\"$ss_uri/images/reson3.png\" alt=\"535b521103baee4253000112_reson3.png\" data-ix=\"banner-rotation\">";?><h2 class="banner-heading wp-widget-editable" data-ix="banner-rotation"><?php echo apply_filters( "widget_title", $instance["wp-widget-editable-0"] );?></h2>
      ...
      <div class="banner-item-two" data-ix="banner-rotation-2">
        <?php echo "<img class=\"banner-image\" src=\"$ss_uri/images/reson3.png\" alt=\"535b521103baee4253000112_reson3.png\" data-ix=\"banner-rotation\">";?><h2 class="banner-heading wp-widget-editable"><?php echo apply_filters( "widget_title", $instance["wp-widget-editable-2"] );?></h2>
